...
union USI_TWI_state {
   ...
   */
  struct {
    unsigned char addressMode : 1;         //!< Address systemMode
    unsigned char masterWriteDataMode : 1; //!< Write data systemMode
    unsigned char memReadMode : 1;         //!< Read memory systemMode
...
void USI_TWI_Master_Initialise(void) {
  ...
  USICR = (0 << USISIE) | (0 << USIOIE) | // Disable Interrupts.
          (1 << USIWM1) | (0 << USIWM0) | // Set USI in Two-wire systemMode.
          (1 << USICS1) | (0 << USICS0) |
...
unsigned char USI_TWI_Start_Read_Write(unsigned char *msg,
  ...
  USI_TWI_state.errorState = 0; // Clears all systemMode bits also
